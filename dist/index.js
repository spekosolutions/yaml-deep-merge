...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var filePathsInput, keyPathInput, keys, filePaths, mergedYamlData, _i, filePaths_1, filePath, content, yamlData, output, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                filePathsInput = core.getInput('config-files');
                core.info("config-files input: ".concat(filePathsInput)); // Debug log for config-files input
                keyPathInput = core.getInput('key-path');
                keys = keyPathInput ? JSON.parse(keyPathInput) : null;
                core.info("key-path input: ".concat(keys)); // Debug log for key-path input
                filePaths = filePathsInput
                    .split('\n')
                    .map(function (path) { return path.trim(); })
                    .filter(function (path) { return path.length > 0; });
                core.info("Parsed file paths: ".concat(filePaths)); // Debug log for parsed file paths
                mergedYamlData = {};
            ...
            case 1:
                ...
                core.info("Processing file: ".concat(filePath)); // Debug log for each file being processed
                return [4 /*yield*/, fs_1.promises.readFile(filePath, 'utf8')];
            case 2:
                content = _a.sent();
                yamlData = yaml.load(content);
                if (yamlData === null || yamlData === undefined) {
                    core.setFailed("Error in reading the YAML file: ".concat(filePath));
                    return [2 /*return*/];
                }
                // Deep merge the YAML data
                mergedYamlData = (0, deepmerge_1.default)(mergedYamlData, yamlData);
                _a.label = 3;
            case 3:
                _i++;
                return [3 /*break*/, 1];
